!function() {
    ...
    (e=>{
        const t = "single-file-lazy-load"
          ...
          , u = e.Blob
          , h = e.JSON
          , p = e.MutationObserver
          , y = e.URL
          , E = new Map
          , v = new Map;
        let w;
        function F() {
            a.addEventListener("single-file-load-deferred-images-start", (()=>S())),
            a.addEventListener("single-file-load-deferred-images-keep-zoom-level-start", (()=>S(!0))),
            ...
            a.addEventListener("single-file-request-fetch-supported", (()=>a.dispatchEvent(new d("single-file-response-fetch-supported")))),
        ...
        function S(r) {
            ...
            if (p < 1) {
                ...
                a.documentElement.style.setProperty("transform", "scale3d(" + p + ", " + p + ", 1)", "important"),
                a.documentElement.style.setProperty("min-height", 100 / p + "vh", "important"),
                R(),
            ...
            if (!r) {
                ...
                window == window.top && [...E].forEach((([t,n])=>{
        ...
        e.CSS && e.CSS.paintWorklet && e.CSS.paintWorklet.addModule) {
            ...
            e.CSS.paintWorklet.addModule = function(n, i) {
                ...
                return n = new y(n,a.baseURI).href,
                a.dispatchEvent(new d("single-file-new-worklet",{
                    detail: {
                        moduleURL: n,
                        options: i
                    }
        ...
        if (e.FontFace) {
            const t = e.FontFace;
            e.FontFace = function() {
                return k(...arguments).then((e=>a.dispatchEvent(new d("single-file-new-font-face",{
                    detail: e
                })))),
                new t(...arguments)
            }
            ...
            a.fonts.delete = function(e) {
                return k(e.family).then((e=>a.dispatchEvent(new d("single-file-delete-font",{
                    detail: e
                })))),
                n.call(a.fonts, e)
            }
        ...
        function B(e) {
            ...
            t) {
                t.addEventListener(r, B, {
                    capture: !0
                }),
                t.addEventListener(o, (()=>t.removeEventListener(r, B)), {
                    once: !0
                });
        ...
        function R() {
            try {
                ...
                w && e.dispatchEvent(new f("scroll"))
            } catch (e) {}
        }
    }
